...
If you're lucky enough to live in a bike share city, but aren't a bike-sharer, you've probably had and encounter with one. Since the inception of Fords' Gobike progam in SF around 2017, the sprawling docking stations periodically buzz with helmeted urbanites launching into the streets and sidewalks, on their way to.. where, excactly?
    Although I am 'bike person,' with a bike or two of my own-- for the last few years I have been driving an electric minivan-load of elementary school kids on an infite loop of pickup drop-off, pickup again. I have more in common with the Muni driver than the average bike sharer. 
...
## Getting nowhere with zero distance trips: 
